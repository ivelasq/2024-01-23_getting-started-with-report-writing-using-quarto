...
format:
  revealjs: 
    ...
    auto-agenda:
      bullets: numbered
      heading: Getting started with report writing using Quarto
    transition: fade
...
- Adding parameters in the YAML require the `{{meta}}` syntax to reference things in the document metadata
